...
class RequestGenerator:
    ...
    def generate_request(self, time=datetime.strptime("00:00:00", "%H:%M:%S")):
        time1 = datetime.strptime("2023-02-01 07:00:00", "%Y-%m-%d %H:%M:%S")
        time2 = datetime.strptime("2023-02-01 10:00:00", "%Y-%m-%d %H:%M:%S")
        time3 = datetime.strptime("2023-02-01 13:00:00", "%Y-%m-%d %H:%M:%S")
        time4 = datetime.strptime("2023-02-01 18:00:00", "%Y-%m-%d %H:%M:%S")
